        ...
        <div class="container">
            <div class="row align-items-center py-5">
                <div class="col-md-8 text-white">
                    <h1>About Raymond</h1>
                    <p>
                        Raymond Trade was established in 2024 with the goal of providing the best and highest-quality commercial products.<br>
                        The main objective of Raymond Trade is to identify and offer profitable and high-quality products to customers. We aim to deliver effective and innovative commercial solutions to help businesses perform better and achieve greater profits.
                    </p>
                </div>
                <div class="col-md-4">
    ...
    <section class="container py-5">
        <div class="row text-center pt-5 pb-3">
            <div class="col-lg-6 m-auto">
                ...
                <p>
                    Our services for all esteemed Raymond customers
                </p>
            </div>
        </div>
        <div class="row">
